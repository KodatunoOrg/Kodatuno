...
#define CTLPNUMMAX  250		// NURBSで用いられるコントロールポイントの数の上限
#define KNOTNUMMAX  250		// NURBSで用いられるノットシーケンスの数の上限
...
// BODYリストの操作関数
BODY *ShiftBodyList(BODY *);			// bodyリストのシフト
void AddBodyList(BODY **,int,BODY *);	// bodyリストに新たなbodyを追加する
void DelBodyList(BODY **,int);			// bodyリストから1つbodyを削除する
BODY *AllocBodyList();					// bodyリストのメモリー確保
BODY *SearchBodyList(BODY *,int);		// bodyリストのサーチ
