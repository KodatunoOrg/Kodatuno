...
// 2つの値の大小比較
// 引数  val1,val2:入力値   flag:精度(HIGH_ACCURACY or or MID_ACCURACY or LOW_ACCURACY or LOW_LOW_ACCURACY)
...
// 引数		a[]：代入される座標値配列		b[]：代入する座標値配列		alim：a[]の配列要素数
